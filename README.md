...
The server should automatically bind to port 1337 using tokio-tls ( because we're not savages )
...
Each team will likely want to use curl or nc to test their integration.
